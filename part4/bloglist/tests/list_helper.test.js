...
describe('favorite', () => {
  ...
  test('no blogs in list', () => {
    const result = listHelper.favoriteBlog([])

    expect(result).toEqual({})
  })

  test('gets the blog with most likes', () => {
  ...
  test('get first blog with same most likes', () => {
    const result = listHelper.favoriteBlog(blogWithSameMostLikes)
